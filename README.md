...
If you want to make some tries with existing users and tasks you can import data by going to the CLI of the `automarker_db` container and then typing the following command:
